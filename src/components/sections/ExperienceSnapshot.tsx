      ...
      <Container className="flex flex-col gap-14">
        <Reveal>
          <SectionHeading
            ...
            title={
              <>
                Real roles, <span className="text-gradient">real systems</span>
              </>
            }
            description="From an applied AI & data-engineering role to independent AI projects and a Data Science degree — the throughline is shipping systems that deliver measurable impact."
          />
        </Reveal>
